...
namespace BibliothequeWinForm.UI
{
    public partial class FormEditAuteur : Form
    {
        ...
        public FormEditAuteur(Auteur auteur)
        {
            InitializeComponent();
        ...
        private void FormEditAuteur_Load(object sender, EventArgs e)
        {
            if (auteur == null)
            {
                MessageBox.Show("Auteur introuvable.", "Erreur",
        ...
        private void BtnEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            auteur.Nom = txtNom.Text.Trim();
            auteur.Prenom = txtPrenom.Text.Trim();

            auteurService.UpdateAuteur(auteur);

            MessageBox.Show("Auteur modifié avec succès !", "Succès",
